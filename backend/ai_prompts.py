...
CONTRACT_ANALYSIS_PROMPT = (
    ...
    "- value: Immer der GESAMTBETRAG BRUTTO inklusive sämtlicher Leistungen, Service und Zusatzpakete. "
    "Ein Gesamtbetrag inkl. MwSt./USt. ist bereits brutto: unverändert übernehmen, Steuer niemals doppelt addieren. "
    "Bei Nettobeträgen nur mit ausdrücklich belegter zugehöriger Umsatzsteuer auf brutto rechnen. "
    "Keine Steuersätze annehmen. Bei wiederkehrenden Kosten nur über eine belegte Laufzeit summieren; "
    "ohne belegten Gesamtbetrag oder eindeutige Berechnungsgrundlage value null lassen.\n"
