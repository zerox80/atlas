...
Jeder abgeschlossene aktuelle Bericht zeigt **Änderungsvorschläge direkt mit Checkbox, bisherigem Wert, vorgeschlagenem Wert und Begründung**. Gewünschte Änderungen anhaken und **Ausgewählte Änderungen übernehmen** anklicken. Nur diese Felder werden gespeichert; weitere Vorschläge bleiben auswählbar. Belege lassen sich zusätzlich aufklappen. Für nicht sinnvolle oder nicht belegbare Änderungen nennt der Bericht konkret, warum die Angabe beibehalten oder das Feld leer gelassen werden sollte. Es gibt keine pauschale Aufforderung zur manuellen Prüfung und keine Scheinbestätigung ohne Änderung.
